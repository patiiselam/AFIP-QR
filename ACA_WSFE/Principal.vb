...
Public Class Principal
    ...
    ''' <remarks></remarks>
    Public Function ObtieneCAETEST(ByVal cuit As String,
        ByVal strId As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ByVal strcantidadreg As String,
        ByVal presta_serv As String,
        ByVal tipo_doc As String,
        ByVal nro_doc As String,
        ByVal tipo_cbte As String,
        ByVal punto_vta As String,
        ByRef cbt_desde As String,
        ByRef cbt_hasta As String,
        ByVal imp_total As String,
        ByVal imp_tot_conc As String,
        ByVal imp_neto As String,
        ByVal impto_liq As String,
        ByVal impto_liq_rni As String,
        ByVal imp_op_ex As String,
        ByVal fecha_cbte As String,
        ByVal fecha_serv_desde As String,
        ByVal fecha_serv_hasta As String,
        ByVal fecha_venc_pago As String,
        ByRef cbte_estado As String,
        ByRef vencimiento_cae As String,
        ByRef cbte_cae As String,
        ByRef motivo_rechazo As String,
        ByRef desc_rechazo As String,
        ByRef codeerr As String,
        ...
        'file2.Close()
    End Function
    Public Function ObtieneCAETEST2(ByVal cuit As String,
        ByVal strId As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ByVal strcantidadreg As String,
        ByVal presta_serv As String,
        ByVal tipo_doc As String,
        ByRef nro_doc As String,
        ByVal tipo_cbte As String,
        ByVal punto_vta As String,
        ByRef cbt_desde As String,
        ByRef cbt_hasta As String,
        ByRef imp_total As String,
        ByVal imp_tot_conc As String,
        ByVal imp_neto As String,
        ByVal impto_liq As String,
        ByVal impto_liq_rni As String,
        ...
        'file2.Close()
    End Function
    Public Function ConsultaCAETESTv1(ByVal cuit As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ByVal tipo_cbte As String,
        ByVal punto_vta As String,
        ByVal cbt_desde As String,
        ByRef cbte_estado As String,
        ByRef vencimiento_cae As String,
    ...
    End Function
    Public Function Consulta2CAETESTv1(ByVal cuit As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ByVal tipo_cbte As String,
        ByVal punto_vta As String,
    ...
    End Function
    Public Function ConsultaCAEPRODv1(ByVal cuit As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ByVal tipo_cbte As String,
        ByVal punto_vta As String,
    ...
    End Function
    Public Function Consulta2CAEPRODv1(ByVal cuit As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ByVal tipo_cbte As String,
        ByVal punto_vta As String,
    ...
    End Function
    Public Function ObtieneCAEPRODv1PILOTE(ByVal cuit As String,
        ByVal TableName As String,
        ByVal TableName2 As String,
        ByVal sServer As String,
        ByVal sDatabase As String,
        ByVal sUser As String,
        ByVal sPassword As String,
        ByVal sGPUser As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ...
        conexionBD = "Data Source=" & sServer & ";" &
        ...
        SQL_STR = "SELECT (SELECT SUBSTRING(TAXREGTN, 1, 11) FROM DYNAMICS..SY01500 WHERE INTERID = DB_NAME()) CUIT, " &
            "TRX.RMDTYPAL, TRX.DOCNUMBR, CONVERT(CHAR(8), SOP.DOCDATE, 112) DOCDATE, TRX.CUSTNMBR, TRX.CUSTNAME, " &
            "SUBSTRING(SOP.TXRGNNUM, 24, 2) TIPODOC, " &
            "SUBSTRING(SOP.TXRGNNUM, 1, 11) NRODOC, " &
            "TRX.FRG_RESP_TYPE, FRG_LETRA1, FRG_PDV, FRG_NRO, FRG_COD,  " &
            "ISNULL(COL1, 0) COL1, ISNULL(COL2, 0) COL2, ISNULL(COL3, 0) COL3, ISNULL(COL4, 0) COL4, ISNULL(COL5, 0) COL5, ISNULL(COL6, 0) COL6, ISNULL(COL7, 0) COL7,  " &
            "ISNULL(COL8, 0) COl8, ISNULL(COL9, 0) COL9, ISNULL(COL10, 0) COL10, TRX.DOCAMNT, TRX.VOIDSTTS,   " &
            "dbo.ACA_TRIBUTOS(SOP.SOPTYPE, SOP.SOPNUMBE) TRIBUTOS, dbo.ACA_IVAXML(SOP.SOPTYPE, SOP.SOPNUMBE) IVAXML, " &
            "'' XMLOPCIONAL, MC.CURR_CODE MONEDA, CASE WHEN SOP.XCHGRATE = 0 THEN 1 ELSE SOP.XCHGRATE END TCAMBIO " &
            "FROM " & Trim(TableName2) & " TRX INNER JOIN " & Trim(TableName) & " TRX2  " &
            "ON TRX.RMDTYPAL = TRX2.RMDTYPAL AND TRX.DOCNUMBR = TRX2.DOCNUMBR  " &
            "INNER JOIN SOP10100 SOP ON TRX.RMDTYPAL = CASE WHEN SOP.SOPTYPE = 3 then 1 ELSE 8 END AND TRX.DOCNUMBR = SOP.SOPNUMBE " &
            "INNER JOIN AWLI40380 AW ON SOP.SOPTYPE = AW.SOPTYPE AND SOP.DOCID = AW.DOCID " &
            "INNER JOIN DYNAMICS..AWLI_MC40200 MC ON SOP.CURNCYID = MC.CURNCYID " &
            " LEFT OUTER JOIN ( " &
            "SELECT A.RMDTYPAL, A.DOCNUMBR, SUM(ISNULL(COL1, 0)) COL1,  SUM(ISNULL(COL2, 0)) COL2,  SUM(ISNULL(COL3, 0)) COL3,  SUM(ISNULL(COL4, 0)) COL4,  SUM(ISNULL(COL5, 0)) COL5,   " &
            " SUM(ISNULL(COL6, 0)) COL6,  SUM(ISNULL(COL7, 0)) COL7,  SUM(ISNULL(COL8, 0)) COL8, SUM(ISNULL(COL9, 0)) COL9, SUM(ISNULL(COL10, 0)) COL10 FROM   " &
            " FRG_RM20105 A LEFT OUTER JOIN  " &
            "(SELECT RMDTYPAL, DOCNUMBR, FRG_Impuestos, TX.TAXDTLID,   " &
            "CASE FRG_Impuestos WHEN 1 THEN TAXDTSLS ELSE 0 END COL1,	" &
            "CASE FRG_Impuestos WHEN 2 THEN TAXDTSLS ELSE 0 END COL2,	" &
            "CASE FRG_Impuestos WHEN 2 THEN TAXAMNT ELSE 0 END COL3,	" &
            "CASE FRG_Impuestos WHEN 2 THEN 1 ELSE 0 END COL4,			" &
            "CASE FRG_Impuestos WHEN 3 THEN TAXAMNT ELSE 0 END COL5,	" &
            "CASE FRG_Impuestos WHEN 4 THEN TAXDTSLS ELSE 0 END COL6,   " &
            "CASE FRG_Impuestos WHEN 5 THEN TAXAMNT ELSE 0 END COL7,    " &
            "CASE FRG_Impuestos WHEN 6 THEN TAXAMNT ELSE 0 END COL8,    " &
            "CASE FRG_Impuestos WHEN 7 THEN TAXAMNT ELSE 0 END COL9,    " &
            "CASE FRG_Impuestos WHEN 8 THEN TAXAMNT ELSE 0 END COL10    " &
            "FROM ( " &
            "select CASE WHEN SOPTYPE = 3 then 1 ELSE 8 END RMDTYPAL, SOPNUMBE DOCNUMBR, TAXDTLID, TAXDTSLS, (STAXAMNT+FRTTXAMT+MSCTXAMT) TAXAMNT from SOP10105 WHERE LNITMSEQ = 0 " &
            ") TX INNER JOIN FRG_TX02001 TX1 ON TX.TAXDTLID = TX1.TAXDTLID) IMP " &
            " ON A.RMDTYPAL = IMP.RMDTYPAL AND A.DOCNUMBR = IMP.DOCNUMBR " &
            " WHERE A.USERID = '" & Trim(sGPUser) & "' " &
            "GROUP BY A.RMDTYPAL, A.DOCNUMBR) TOTIMP ON TRX.RMDTYPAL = TOTIMP.RMDTYPAL AND TRX.DOCNUMBR = TOTIMP.DOCNUMBR " &
            ...
            If objFEResponse IsNot Nothing Then
                ...
                For d = 0 To (ii - 1)
                    ...
                    Else
                        cbte_comentario = ""
                    End If
                    SQL_STR = "UPDATE FRG_RM20101 SET FRG_CAE = '" & cbte_cae & "', FRG_CAE_DUE = '" & vencimiento_cae & "', " &
                        "FRG_ESTADO = '" & cbte_estado & "', FRG_MOTIVO = '" & cbte_comentario & "' " &
                        "WHERE CONVERT(INT, FRG_PDV) = " & cbte_pdv & " AND CONVERT(INT, FRG_COD) = " & cbte_tipo & " " &
        ...
        ObtieneCAEPRODv1PILOTE = True
    End Function
    Public Function ObtieneCAETESTv1PILOTE(ByVal cuit As String,
        ByVal TableName As String,
        ByVal TableName2 As String,
        ByVal sServer As String,
        ByVal sDatabase As String,
    ...
    Public Function ObtieneCAEPRODv1PI(ByVal cuit As String,
        ByVal strId As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ByVal strcantidadreg As String,
        ...
        ByRef codeerr As String,
        ByRef msgerr As String,
        ByRef reproceso As String,
        ByVal concepto As String,
        ByVal moneda As String,
        ByVal tipo_cbio As String,
        ByVal tributos As String,
        ByVal ivastr As String,
        ...
        'file2.Close()
    End Function
    Public Function ObtieneCAEPRODv1(ByVal cuit As String,
        ByVal strId As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ByVal strcantidadreg As String,
        ...
        'file2.Close()
    End Function
    Public Function ObtieneCAETESTv1PI(ByVal cuit As String,
        ByVal strId As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ByVal strcantidadreg As String,
        ...
        'file2.Close()
    End Function
    Public Function ObtieneCAEPIMSAL(
        ...
        Dim derr As Integer = 0
        Dim ii, tt As Integer
        Dim tribxml, opcionalxml, cbtesasocxml As String
        Dim tipotrib, tipoiva, opcionalesid, cbtesasocid As Integer
        Dim objFERequest As New wsfev1t.FECAERequest
        Dim objFECabeceraRequest As New wsfev1t.FECAECabRequest
        Dim ArrayOfFEDetalleRequest(indicemax) As wsfev1t.FECAEDetRequest
        Dim objFEResponse As New wsfev1t.FECAEResponse
        Dim objFEResponseOPC As New wsfev1t.OpcionalTipoResponse
        Dim ArrayOfFEDetalleResponse(indicemax) As wsfev1t.FECAEDetResponse
        Dim ArrayOfTributoTax(0) As wsfev1t.Tributo
        Dim ArrayOfAlicIva(0) As wsfev1t.AlicIva
        Dim ArrayOfAdicionales(0) As wsfev1t.Opcional
        Dim ArrayOfCbtesASoc(0) As wsfev1t.CbteAsoc
        Dim objFEDetalleResponse(indicemax) As wsfev1t.FECAEDetResponse
        Dim TributoId(10) As Integer
        Dim TributoDesc(10) As String
        Dim TributoBaseImp(10), TributoAlic(10), TributoImporte(10) As Double
        ...
        For d = 0 To (indicemax)
            ...
            With objFEDetalleRequest
                ...
                'probar detalle request
                Dim detreq As String = ""
                'detreq = "valores de objFEDDetallerRequest:  Concepto: " + .Concepto + ", Moneda: " + .MonId + ", Tipo cambio: " + .MonCotiz + ", Nrodoc: " + .DocNro
                'detreq += +", CbteDesde: " + .CbteDesde + ", CbteHasta: " + .CbteHasta + ", ImpTotal: " + .ImpTotal + ",ImpTotConc: " + .ImpTotConc + ", ImpNeto: " + .ImpNeto
                'detreq += ",ImpIVA: " + .ImpIVA + ",ImpTrib: " + .ImpTrib + ", ImpOpEx: " + .ImpOpEx + ", CbteFch: " + .CbteFch
                'MsgBox(detreq)

                'Ctes ASociados
                cbtesasocxml = ""
                t = 1
                If cbtesasocstr <> "" Then
                    Do While (testxmlcbtesasoc.Read())
                        Select Case testxmlcbtesasoc.NodeType
                            Case XmlNodeType.Element 'Mostrar comienzo del elemento.
                                cbtesasocxml = cbtesasocxml & "<" & testxmlcbtesasoc.Name & ">"
                                Select Case testxmlcbtesasoc.Name
                                    Case "Tipo"
                                        cbtesasocid = 1
                                    Case "PtoVta"
                                        cbtesasocid = 2
                                ...
                                End Select
                            Case XmlNodeType.Text 'Mostrar el texto en cada elemento.
                                cbtesasocxml = cbtesasocxml & testxmlcbtesasoc.Value
                                Select Case cbtesasocid
                                    Case 1
                                        CbtesAsocTipo(t) = testxmlcbtesasoc.Value
                                    Case 2
                                        CbtesAsocPtoVta(t) = testxmlcbtesasoc.Value
                                    Case 3
                                        CbtesAsocNro(t) = testxmlcbtesasoc.Value
                                    Case 4
                                        CbtesAsocCuit(t) = testxmlcbtesasoc.Value
                                    Case 5
                                        CbtesAsocCbteFch(t) = testxmlcbtesasoc.Value
                                End Select
                            Case XmlNodeType.EndElement
                                cbtesasocxml = cbtesasocxml & "</" & testxmlcbtesasoc.Name & ">"
                                If testxmlcbtesasoc.Name = "CbteAsoc" Then
                                    t = t + 1
                                End If
                        End Select
                    Loop
                    ...
                    For tt = 1 To t - 1
                        ...
                        Dim CbteAsoc As New wsfev1t.CbteAsoc

                        With CbteAsoc
                            .Tipo = CbtesAsocTipo(tt)
                            .PtoVta = CbtesAsocPtoVta(tt)
                            .Nro = CbtesAsocNro(tt)
                            .Cuit = CbtesAsocCuit(tt)
                        ...
                        End If
                        ArrayOfCbtesASoc(tt - 1) = CbteAsoc
    ...
    Public Function ArmarCadena(
        ...
        ByVal tipo_doc As String,
        ByVal nro_doc As String,
        ByVal tipo_cod_aut As String,
        ByVal cbte_cae As String) As String
    ...
    Function ObtieneCAEPIPRODMSAL(
        ...
        Dim ArrayOfAlicIva(0) As wsfev1p.AlicIva
        Dim ArrayOfAdicionales(0) As wsfev1p.Opcional
        Dim ArrayOfCbtesASoc(0) As wsfev1p.CbteAsoc
        Dim objFEDetalleResponse(indicemax) As wsfev1p.FECAEDetResponse
        Dim TributoId(10) As Integer
        Dim TributoDesc(10) As String
        Dim TributoBaseImp(10), TributoAlic(10), TributoImporte(10) As Double
            ...
            With objFEDetalleRequest
                ...
                If cbtesasocstr <> "" Then
                    ...
                    For tt = 1 To t - 1
                        ...
                        Dim CbteAsoc As New wsfev1p.CbteAsoc
        ...
        Try
            ...
            objFEDetalleResponse = objFEResponse.FeDetResp
            If Not objFEResponse.Errors Is Nothing Then
                'MsgBox("Paso el not objFEresponse.error is nothing")
                desc_rechazo = objFEResponse.Errors(0).Msg
                ObtieneCAEPIPRODMSAL = "False|" + desc_rechazo + "|||||||"

            Else
                ii = objFEResponse.FeCabResp.CantReg
                'MsgBox("paso el el del if not objeresponse.error is nothing")
                reproceso = objFEResponse.FeCabResp.Reproceso
                For d = 0 To (ii - 1)
                    'If objFEResponse.FedResp(d) Is not Nothing Then
                    cbte_estado = objFEResponse.FeDetResp(d).Resultado
                    ...
                    'Creo e inicializo ver y tipcodaut
                    Dim ver As String = "1"
                    Dim tipcodaut As String = "E"
                    'llamar a la funcion armar la cadena
                    cadena = ArmarCadena(ver, fecha_cbte, cuit, punto_vta, tipo_cbte, cbt_desde, imp_total, moneda, tipo_cbio, tipo_doc, nro_doc, tipcodaut, cbte_cae)
                    ...
                    ObtieneCAEPIPRODMSAL = "True|" + desc_rechazo + "|" + reproceso + "|" + cbte_estado + "|" + vencimiento_cae + "|" + cbte_cae + "|" + cbt_desde + "|" + cbt_hasta + "|"
    ...
    Public Function UltimoNumeroProdv1(ByVal cuit As String, ByVal token As String, ByVal sign As String,
            ByVal tipo_cbte As String, ByVal punto_vta As String, ByRef codeerr As String,
    ...
    End Function
    Public Function UltimoNumeroTESTv1(ByVal cuit As String, ByVal token As String, ByVal sign As String,
            ByVal tipo_cbte As String, ByVal punto_vta As String, ByRef codeerr As String,
            ByRef msgerr As String) As String
    ...
    Public Function ObtieneTicket(
        ByVal strProdMode1 As String,
        ByVal strUrlWsaaWsdl1 As String,
        ByVal strIdServicioNegocio1 As String,
        ByVal strRutaCertSigner1 As String,
        ByVal strPasswordSecureString1 As String,
        ByVal strProxy1 As String,
        ByVal strProxyUser1 As String,
        ByVal strProxyPassword1 As String,
        ByRef UniqueID1 As String,
        ByVal Service1 As String,
        ByRef GenerationTime1 As String,
        ByRef ExpirationTime1 As String,
        ByRef Sign1 As String,
        ByRef Token1 As String,
    ...
    Public Function ObtieneTicketMSAL(
        ByVal strProdMode1 As String,
        ByVal strUrlWsaaWsdl1 As String,
        ByVal strIdServicioNegocio1 As String,
        ByVal strRutaCertSigner1 As String,
        ...
        ByVal strProxyPassword1 As String,
        ByVal Service1 As String,
        Optional ByVal DifGMTBA As Integer = 3) As String

        ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12

        Dim UniqueID1 As String
        Dim GenerationTime1 As String
        Dim ExpirationTime1 As String
        Dim Sign1 As String
        ...
        Try
            ...
            strError = sError
            If strTicketRespuesta = "" Then
                Return "|-20|" + strError + "|||||Token|"
            End If
        Catch excepcionAlObtenerTicket As Exception
            'MsgBox("***EXCEPCION AL OBTENER TICKET:" & excepcionAlObtenerTicket.Message)
            strError = "***EXCEPCION AL OBTENER TICKET:" & excepcionAlObtenerTicket.Message
            Return "|-10|" + strError + "|||||Token|"
        ...
        'MsgBox("***Resultado:" & "|0|" + strError + "|" + UniqueID1 + "|" + GenerationTime1 + "|" + ExpirationTime1 + "|" + Sign1 + "|Token" + Token1 + "|")

        'Return "|0|" + strError + "|" + UniqueID1 + "|" + GenerationTime1 + "|" + ExpirationTime1 + "|" + Sign1 + "|Token" + "PRUEBAMSALPARAENCONTRARTOK" + "|"

        Return "|0|" + strError + "|" + UniqueID1 + "|" + GenerationTime1 + "|" + ExpirationTime1 + "|" + Sign1 + "|Token" + Token1 + "|"
    ...
    End Function
    Public Function ObtieneCAEPROD(ByVal cuit As String,
        ByVal strId As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ByVal strcantidadreg As String,
        ...
        'file2.Close()
    End Function
    Public Function ObtieneCAEPROD2(ByVal cuit As String,
        ByVal strId As String,
        ByVal strToken As String,
        ByVal strSign As String,
        ByVal strcantidadreg As String,
    ...
    End Function
    Public Function UltimoNumeroTEST(ByVal cuit As String, ByVal token As String, ByVal sign As String,
            ByVal tipo_cbte As String, ByVal punto_vta As String, ByRef codeerr As String,
            ByRef msgerr As String) As String
    ...
    End Function
    Public Function UltimoNumeroPROD(ByVal cuit As String, ByVal token As String, ByVal sign As String,
            ByVal tipo_cbte As String, ByVal punto_vta As String, ByRef codeerr As String,
            ByRef msgerr As String) As String
    ...
    End Function
    Public Function EnviarMail(ByVal CorreoServer As String, ByVal CorreoCuenta As String, ByVal CorreoUser As String,
        ByVal CorreoPassword As String, ByVal CorreoPort As Integer, ByVal CorreoSSLSecurity As Integer,
        ByVal CorreoResponderA As String, ByVal CorreoEnviarA As String, ByVal sMensaje As String, ByVal sAsunto As String,
...
Class LoginTicket
    ...
    ByRef UniqueID1 As String,
    ByRef GenerationTime1 As DateTime,
    ByRef ExpirationTime1 As DateTime,
    ByRef Sign1 As String,
    ByRef Token1 As String,
    ByRef sError As String,
    ByVal DifGMTBA As Integer
    ) As String
